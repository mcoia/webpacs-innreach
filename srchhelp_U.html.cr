...
<TITLE>INNOPAC Added Keyword Search </TITLE>
<!-- #EndEditable --> 
</HEAD>
...
<!-- #BeginEditable "body" --> 
  ...
  <p> 
  <div align="center"> Type the <B>Tables of Contents and Notes Word(s)</B> you 
    want, then press <b>&lt;Enter&gt;</b> or click <b>Submit Search</b> 
    <FORM METHOD=GET>
      <INPUT TYPE=TEXT NAME=SEARCH MAXLENGTH=64 SIZE=48 ALIGN=CENTER>
      <br>
      <INPUT TYPE=SUBMIT VALUE="Submit Search">
    </FORM>
    <A HREF="/search/"><IMG SRC="/screens/newsrch.gif" BORDER=0
ALT="[START OVER]"></A> 
    <P> INNOPAC will search the library's records, looking for the words that 
      you type in various fields,<br>
      such as title, contents notes, corporate names, etc. 
    <p> You may use the Boolean operators <b>AND, OR and NOT</b> <br>
    ...
    <UL>
      <TABLE>
        <TR>
          <TD>
            <LI>Soviet <b>and</b> Russian
          </TD>
        </TR>
        <TR>
          <TD>
            <LI>Soviet Union <b>or</b> Russia
          </TD>
        </TR>
        <TR>
          <TD>
            <LI>Mexico <b>not</b> New
          </TD>
        </TR>
        <TR>
          <TD>
            <LI>(games <b>or</b> toys) and (child* <b>or</b> infant*)
          </TD>
        </TR>
      </TABLE>
    </UL>
